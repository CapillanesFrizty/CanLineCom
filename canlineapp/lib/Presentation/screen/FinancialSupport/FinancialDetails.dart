...
class _FinancialDetailsState extends State<FinancialDetails> {
  ...
  Widget _buildPartyListSection(Map<String, dynamic> data) {
    final partyLists = [
      {
        'name': 'Gabriela Women\'s Party',
        'color': const Color(0xFFE57373),
        'location': 'Quezon City, Metro Manila',
        'contact': '(02) 8931-2644',
        'description': 'Advocate for women\'s rights and gender equality',
        'icon': Icons.woman
      },
      {
        'name': 'Senior Citizens Party',
        'color': const Color(0xFF81C784),
        'location': 'Makati City, Metro Manila',
        'contact': '(02) 8556-0923',
        'description': 'Represents elderly rights and welfare',
        'icon': Icons.elderly
      },
      {
        ...
        'contact': '(02) 8735-6068',
        'description': 'Social democratic political party',
        'icon': Icons.people
      },
      {
        'name': 'Bayan Muna',
        ...
        'location': 'Quezon City, Metro Manila',
        'contact': '(02) 8931-6593',
        'description': 'Advocates for national sovereignty',
      ...
      },
      {
        ...
        'location': 'Quezon City, Metro Manila',
        'contact': '(02) 8931-5001',
        'description': 'Represents teachers and education sector',
        'icon': Icons.school
      },
    ];
            ...
            return Card(
              ...
              child: ListTile(
                ...
                leading: CircleAvatar(
                  backgroundColor: party['color'] as Color,
                  child: Icon(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () => _showPartyDetails(context, party),
                ),
              ),
            );
          },
